...
const utils = {
    ...
    *infiniteNumber() {
    ...
    ocr(url) {
        console.log(url);
<<<<<<< HEAD
        let ocrUrl = `http://${process.env.OCR_HOST}:${process.env.OCR_PORT}/ocr/url/text`;
=======
        console.log("?:", process.env["ocr_server"]);
        console.log("??:", process.env.OCR_HOST);
        let ocrUrl = `http://${process.env["NUMBER"]}:${process.env["NUMBER"]}/ocr/url/text`;
>>>>>>> 62605b3467d0eb45d8fff033f7409a70737a658e
        console.log(ocrUrl);
